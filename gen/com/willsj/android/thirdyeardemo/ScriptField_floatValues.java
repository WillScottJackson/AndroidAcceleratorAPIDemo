 ...
 * @hide
 */
public class ScriptField_floatValues extends android.renderscript.Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.F32(rs), "C");
        return eb.create();
    }

    private  ScriptField_floatValues(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_floatValues(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_floatValues(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_floatValues create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_floatValues obj = new ScriptField_floatValues(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_floatValues create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_floatValues create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_floatValues create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_floatValues obj = new ScriptField_floatValues(rs);
    ...
    public static ScriptField_floatValues createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_floatValues obj = new ScriptField_floatValues(rs);
        Type t = tb.create();
    ...
    public synchronized void set_C(int index, float v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(Item.sizeof * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
    ...
    public synchronized float get_C(int index) {
        if (mItemArray == null) return 0;
