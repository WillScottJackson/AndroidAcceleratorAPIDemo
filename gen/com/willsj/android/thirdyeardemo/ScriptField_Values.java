 ...
 * @hide
 */
public class ScriptField_Values extends android.renderscript.Script.FieldBase {
    ...
    public static Element createElement(RenderScript rs) {
        ...
        eb.add(Element.I32(rs), "C");
        return eb.create();
    }

    private  ScriptField_Values(RenderScript rs) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    }

    public  ScriptField_Values(RenderScript rs, int count) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
        init(rs, count);
    ...
    public  ScriptField_Values(RenderScript rs, int count, int usages) {
        mItemArray = null;
        mIOBuffer = null;
        mElement = createElement(rs);
    ...
    public static ScriptField_Values create1D(RenderScript rs, int dimX, int usages) {
        ScriptField_Values obj = new ScriptField_Values(rs);
        obj.mAllocation = Allocation.createSized(rs, obj.mElement, dimX, usages);
        return obj;
    }

    public static ScriptField_Values create1D(RenderScript rs, int dimX) {
        return create1D(rs, dimX, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_Values create2D(RenderScript rs, int dimX, int dimY) {
        return create2D(rs, dimX, dimY, Allocation.USAGE_SCRIPT);
    }

    public static ScriptField_Values create2D(RenderScript rs, int dimX, int dimY, int usages) {
        ScriptField_Values obj = new ScriptField_Values(rs);
    ...
    public static ScriptField_Values createCustom(RenderScript rs, Type.Builder tb, int usages) {
        ScriptField_Values obj = new ScriptField_Values(rs);
        Type t = tb.create();
    ...
    public synchronized void set_C(int index, int v, boolean copyNow) {
        if (mIOBuffer == null) mIOBuffer = new FieldPacker(Item.sizeof * getType().getX()/* count */);
        if (mItemArray == null) mItemArray = new Item[getType().getX() /* count */];
        if (mItemArray[index] == null) mItemArray[index] = new Item();
    ...
    public synchronized int get_C(int index) {
        if (mItemArray == null) return 0;
